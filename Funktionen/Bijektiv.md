...
**Beispiel:** $f: \mathbb{R^+_{0}} \to \mathbb{R^+_{0}} \quad mit \quad x \to x_{2}$ ist bijektiv.

**Zusätzlich:** Sind zwei Funktionen $f: A \to B$ und $g: B \to C$ bijektiv, so ist auch die Komposition (Verkettung) $g \circ f: A \to C$ bijektiv.